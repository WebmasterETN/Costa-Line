...
<section class="hero">
  <div class="hero__content">
    <h1 class="hero__title">Autobuses a Cuernavaca con Costaline</h1>
    <p class="hero__subtitle">
      Llega a la capital de Morelos con un viaje rápido, cómodo y seguro. Costaline te conecta desde CDMX y otras ciudades con unidades modernas y climatizadas.
    </p>
  </div>
</section>
...
<section class="features">
  <div class="container">
    <h2 class="section-title">¿Por qué viajar con Costaline a Cuernavaca?</h2>
    ...
    <div class="features__grid">
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">
          Viaja con asientos reclinables, aire acondicionado y unidades modernas que hacen tu trayecto más agradable.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">
          Precios competitivos y descuentos exclusivos al comprar tu boleto en línea.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">
          Operadores capacitados y protocolos de seguridad que garantizan un viaje confiable.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">
          Llega a una ciudad con acceso directo a destinos turísticos como Tepoztlán, Xochicalco y el Tepozteco.
        </p>
      </div>
...
<section class="route-info">
  <div class="container route-info__container">
    <h2 class="section-title">Ruta destacada: CDMX Taxqueña → Cuernavaca</h2>
    ...
    <div class="route-info__card">
      ...
      <div class="route-info__details-grid">
        ...
        <div class="detail-item">
          ...
          <p class="detail-item__value">Salidas constantes durante el día</p>
        </div>

        <div class="detail-item">
          <p class="detail-item__label">Tipo de autobús</p>
          <p class="detail-item__value">Servicio Primera / Plus</p>
        </div>
      </div>
...
<section class="attractions">
  <div class="container">
    <h2 class="section-title">Lugares para visitar en Cuernavaca</h2>
    ...
    <div class="attractions__grid">
      ...
      <div class="attraction-card">
        <div class="attraction-card__image" style='background-image: url("../src/assets/img/destinos-img/cuernavaca/jardin-borda.webp")'></div>
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Jardín Borda</h3>
        </div>
      </div>
    ...
    <div class="faq__list">
      ...
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Cuánto cuesta el boleto a Cuernavaca?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">
          Los precios varían según temporada y punto de origen. Consulta el costo actualizado al elegir tu fecha de viaje.
        </p>
      </details>

      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Qué horarios tienen hacia Cuernavaca?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">
          Disponemos de salidas frecuentes durante todo el día desde CDMX y otras ciudades. Revisa los horarios al comprar tu boleto.
        </p>
      </details>
      ...
      <details class="faq-item">
        ...
        <p class="faq-item__answer">
          Autobuses climatizados, asientos reclinables y operadores experimentados para un viaje seguro y cómodo.
        </p>
      </details>
...
<section class="cta">
  <div class="container">
    <h2 class="cta__title">¡Viaja a Cuernavaca con Costaline!</h2>
    <p class="cta__subtitle">Reserva tu boleto hoy y disfruta un viaje rápido y seguro hacia Morelos.</p>
    <a href="../destinos/autobus-a-cuernavaca.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer">
