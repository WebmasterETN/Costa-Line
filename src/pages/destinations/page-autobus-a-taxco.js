...
class PageAutobusATaxco extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
            <app-cotiza></app-cotiza>
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/web/taxco-web.webp","mediumImage": "../src/assets/img/banner/tablet/taxco-tablet.webp", "smallImage": "../src/assets/img/banner/movil/taxco-mobile.webp", "link": "#index.html/banner1"}]'
            >
            </app-banner-slider>
              ...
              <section class="__section __section__destiny__food">
                ...
                <p class="__paragraph__xl">Taxco de Alarcón, la joya de plata de Guerrero, es reconocida por su singular patrimonio culinario. La gastronomía de la ciudad es una deliciosa fusión de influencias indígenas y españolas, con un toque único de sabor montañoso, dando como resultado una variedad de platillos que reflejan la identidad cultural de la región.</p>
                 <article class="container-cards__food">
                    <app-card-open-modal cards-data-src="../src/data/platillos-taxco.json"></app-card-open-modal>
                </article>
             </section>
...
customElements.define("page-autobus-a-taxco", PageAutobusATaxco);
