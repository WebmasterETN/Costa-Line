...
class AppBoletosAutobusChilpancingo extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/web/chilpancingo-web.webp","mediumImage": "./src/assets/img/banner/tablet/chilpancingo-tablet.webp", "smallImage": "./src/assets/img/banner/movil/chilpancingo-mobile.webp", "link": "#index.html/banner1"}]'
            >
            </app-banner-slider>
...
customElements.define(
  "page-boletos-de-autobus-chilpancingo",
