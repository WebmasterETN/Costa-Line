...
class LayoutFestivalViajes extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/promociones/web/festival-de-viajes-web.webp","mediumImage": "../src/assets/img/banner/promociones/tablet/festival-de-viajes-tablet.webp", "smallImage": "../src/assets/img/banner/promociones/movil/festival-de-viajes-mobile.webp", "link": "#index.html/banner1"}
                ]'
            >
            </app-banner-slider>
