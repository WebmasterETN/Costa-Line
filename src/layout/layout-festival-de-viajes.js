...
class LayoutFestivalViajes extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/festival-de-viajes.png","mediumImage": "../src/assets/img/banner/Tablet-1.png", "smallImage": "../src/assets/img/banner/Movil-1.png", "link": "#index.html/banner1"}
                ]'
            >
            </app-banner-slider>
