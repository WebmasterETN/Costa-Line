            ...
            <article class="__bg-blue">
                ...
                <ol type="numeric" class="__order-list-column">
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text"><b>BUEN FIN</b> aplica para venta en línea <b>(App ETN y sitio web)</b> y centro de contacto telefónico y se puede realizar la compra con cualquier forma de pago.</p>
                    </li>
                    <li class="__terms-purchase-item">
                    ...
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            En las rutas definidas para <b>BUEN FIN</b> no se podrán vender boletos abiertos, solo confirmados. Se podrán vender boletos abiertos pero con una tarifa a precio de adulto.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            Las tarifas de <b>BUEN FIN</b> no aplican ni son acumulables con otro tipo de descuentos o promociones.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            Las Tarifas de <b>BUEN FIN</b> son personales e intransferibles, para hacerla efectiva el cliente deberá presentar una identificación oficial antes de abordar el autobús, si no cumple con el requisito deberá pagar la Tarifa Completa.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            El periodo para comprar boletos de autobús y obtener la tarifa de <b>BUEN FIN </b>es a partir del primer minuto del día siguiente a la consulta y hasta un mes posterior. En caso de NO contar con tarifa anticipada, aplica el descuento del 10% por compra en internet por viaje sencillo y 10% por viaje redondo comprando en línea o bien aplica el 10% por viaje redondo comprando en taquilla.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                    ...
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            La tarifa de <b>BUEN FIN</b> no aplica en la compra de boletos con beneficios de INAPAM, menores, estudiantes, maestros y boletos abiertos.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            La acumulación de puntos Doters de un boleto con tarifa de <b>BUEN FIN</b>, deberá calcularse sobre la tarifa que pagó el cliente en efectivo o tarjeta bancaria y/o cualquier otra forma de pago (Pagos referenciados, exceptuando los puntos). Los puntos Doters generados pueden ser utilizados como forma de pago y se apegaran las mismas políticas y restricciones de Pago con puntos de Doters.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
        ...
        <section class="__sections">
            <article class="__bg-white">
                ...
                <ol type="numeric" class="__order-list-column">
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            Para las referencias que genere el sistema por operaciones de <b>BUEN FIN</b> el cliente tendrá 24 horas para realizar el pago correspondiente.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                    ...
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            En las reservaciones que involucren operaciones de <b>BUEN FIN</b> y Tarifas Completas el cliente tendrá 24 horas para realizar el pago correspondiente.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
        ...
        <section class="__sections">
            <article class="__bg-blue">
                ...
                <ol type="numeric" class="__order-list-column">
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
                            Para tarifas de <b>BUEN FIN</b> no aplica cambio de nombre de pasajero.
                        </p>
                    </li>
                    <li class="__terms-purchase-item">
                        <p class="__terms-purchase-text">
