...
class LayoutOfertasClick extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/promociones/web/ofertas-1-click-web.webp","mediumImage": "../src/assets/img/banner/promociones/tablet/ofertas-en-1-click-tablet.webp", "smallImage": "../src/assets/img/banner/promociones/movil/ofertas-en-1-click-mobile.webp", "link": "#index.html/banner1"}
                ]'
            >
            </app-banner-slider>
...
customElements.define("layout-ofertas-en-1-click", LayoutOfertasClick);
